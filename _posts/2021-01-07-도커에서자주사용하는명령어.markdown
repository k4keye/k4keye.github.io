...
update , git, net-toole 을 install 하고<br/><br/>

git 프로젝트를 clone 한다.<br/><br/>

로컬에 있는 test.sh를 컨테이너에 /home 경로로 복사한다.<br/><br/>

timezone 을 서울로 한다.<br/><br/>

clone를 받은 프로젝트로 경로를 이동하여 실행 권한을 준다.<br/><br/>
